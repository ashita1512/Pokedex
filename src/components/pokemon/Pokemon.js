          ...
          <div className='card-body'>
            ...
            <div className='row'>
              <div className='col-md-6'>
                <div className='row'>
                  <div className='col-md-6'>
                    <h6 className='float-right text-center'>Height:</h6>
                  </div>
                  <div className='col-md-6'>
                    <h6 className='float-left'>{this.state.height} ft.</h6>
                  </div>
                  <div className='col-md-6'>
                    <h6 className='float-right text-center'>Weight:</h6>
                  </div>
                  <div className='col-md-6'>
                    <h6 className='float-left'>{this.state.weight} lbs.</h6>
                  </div>
                  <div className='col-md-6'>
                    <h6 className='float-right text-center'>Catch Rate:</h6>
                  </div>
                  <div className='col-md-6'>
                    <h6 className='float-left'>{this.state.catchRate} %</h6>
                  </div>
                  <div className='col-md-6'>
                    <h6 className='float-right text-center'>Gender Ratio:</h6>
                  </div>
                  <div className='col-6'>
                    <div className='progress'>
                      <div
